...
class _CartPageState extends State<CartPage> {
                        ...
                        SizedBox(
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                              ...
                              boxShadow: [
                                BoxShadow(
                                  color: constants.bgColorPink.withOpacity(0.25),
                                  blurRadius: 12,
                                  offset: const Offset(0, 6),
                                ),
                              ],
  ...
  Widget _buildAddressCard() {
    ...
    if (_currentAddress != null) {
      ...
      addressLabel = _currentAddress!['label'] ?? 'Address';
      fullAddressString = "$door, $street";
    }
      ...
      child: Row(
        children: [
          Container(
            ...
            height: 40,
            decoration: BoxDecoration(
              color: constants.bgColorPink.withOpacity(0.08),
              shape: BoxShape.circle,
            ),
            child: const Icon(Icons.location_on, color: constants.bgColorPink, size: 20),
          ),
          ...
          OutlinedButton(
            ...
            style: OutlinedButton.styleFrom(
              side: BorderSide(color: constants.bgColorPink.withOpacity(0.3), width: 1),
                        ...
                        children: [
                          ...
                          GestureDetector(
                            ...
                            child: Container(
                              ...
                              child: Icon(Icons.add, size: 14, color: constants.bgColorPink),
                            ),
                          ),
                        ],
                      ),
