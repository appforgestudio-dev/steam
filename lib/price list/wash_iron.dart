...
//
// class WashAndIronPage extends StatefulWidget {
//   const WashAndIronPage({super.key});
//
//   @override
//   _WashAndIronPageState createState() => _WashAndIronPageState();
// }
//
// class _WashAndIronPageState extends State<WashAndIronPage> {
//   // State variables
...
//       setState(() {
//         if (savedCart != null && savedCart['washAndIronItems'] != null) {
//           final loadedItems = savedCart['washAndIronItems'] as Map<String, dynamic>? ?? {};
...
//         SnackBar(
//           content: Text("Failed to load saved cart please check Internet: $e"),
...
//       ScaffoldMessenger.of(context).showSnackBar(
//         SnackBar(
//           content: Text("Error loading prices. Please check you network connection"),
//           backgroundColor: Colors.red,
//         ),
//       );
//     }
...
//         washAndIronItems: itemQuantities,
...
//       ScaffoldMessenger.of(context).showSnackBar(
//         SnackBar(
//           content: Text("Error saving. Please check you network connection"),
//           backgroundColor: Colors.red,
//         ),
//       );
//     }
//   }
//
//   Future<void> _saveAndNavigateToCartPage() async {
//     try {
//       final savedCart = await CartPersistence.loadCart() ?? {};
//
...
//       ScaffoldMessenger.of(context).showSnackBar(
//         SnackBar(
//           content: Text("Error saving cart. Please check you network connection or try again later"),
//           backgroundColor: Colors.red,
//         ),
//       );
//     }
...
//   }
//
//   // Build section for pricing plans
...
//                             _calculateTotal();
//                           });
//                           _saveSelections(); // Save cart dynamically
//                         },
//                         child: Container(
//                           width: 30,
//                           height: 30,
//                           decoration: BoxDecoration(
//                             color: isSelected ? Colors.red : bgColorPink,
...
class _WashAndIronPageState extends State<WashAndIronPage> {
  ...
  // --- Mobile-specific UI Build Method (Preserved) ---
  Widget _buildSection(String title, List<Map<String, dynamic>> items, double aspectRatio) {
    if (items.isEmpty) return const SizedBox();
  ...
  Widget _buildWebLayout() {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: primaryColor,
        elevation: 0,
        title: const Text("Wash & Iron", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
        centerTitle: true,
        actions: [
          Padding(
            ...
            child: IconButton(
              ...
              onPressed: _saveAndNavigateToCartPage,
            ),
          ),
        ],
      ),
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text("Wash & Iron Total", style: TextStyle(fontSize: 16, color: Colors.grey)),
            const SizedBox(height: 4),
                ...
                children: [
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("Wash & Iron Total", style: TextStyle(fontSize: 14, color: Colors.grey[700])),
