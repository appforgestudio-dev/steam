...
//           totalItems += (savedCart['prePlatedItems'] as Map<String, dynamic>? ?? {}).length; // Updated to count entries
...
//       totalItems += (updatedCart?['prePlatedItems'] as Map<String, dynamic>? ?? {}).length; // Updated to count entries
//       totalItems += itemQuantities.length;
//       setState(() {
//         _totalCartItems = totalItems;
//       });
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text("Wash & Starch Total", style: TextStyle(fontSize: 16, color: Colors.grey)),
            const SizedBox(height: 4),
                ...
                children: [
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("Wash & Starch Total", style: TextStyle(fontSize: 14, color: Colors.grey[600])),
